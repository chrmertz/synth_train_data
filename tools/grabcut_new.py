...
The right button might be acting up: it shows a drop down menu when clicked
do this:
 right click at one corner
 right click at another place (menu should disappear)
 right click at second corner
 right click again
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        print("No input image given, so loading default image, example.jpg \n")
